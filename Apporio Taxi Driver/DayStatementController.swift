...
class DayStatementController: UIViewController , ParsingStates, UITableViewDataSource , UITableViewDelegate {
    ...
    func setupView(){
     dailyearningtextlabel.text = "Daily Earning".localized
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell
    {
        ...
        rideid.text = "CRN" + (self.mydata.details?.fullRideDetails?[indexPath.row].rideId!)! + " " + (self.mydata.details?.fullRideDetails?[indexPath.row].rideTime!)!
