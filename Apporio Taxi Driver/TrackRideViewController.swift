...
class TrackRideViewController: UIViewController, CLLocationManagerDelegate , ParsingStates ,GMSMapViewDelegate ,GMSAutocompleteViewControllerDelegate {
    ...
    @IBOutlet weak var navigatetextlabel: UILabel!
    
    @IBOutlet weak var newmessagetextlabel: UILabel!
    
    @IBOutlet weak var reachedbtntext: UIButton!
    
    @IBOutlet weak var clicktoviewtextlabel: UILabel!

    @IBOutlet weak var endtripbtntext: UIButton!
    @IBOutlet weak var begintripbtntext: UIButton!
    @IBOutlet weak var begincancelbtntext: UIButton!
    
    
    var installedNavigationApps : [String] = ["Apple Maps"]
    
    @IBOutlet weak var locatedcancelbtntext: UIButton!
    var enddata: RideEnd!
   ...
   var distanceinmetervalue = 0
    ...
    override func viewDidLoad() {
        ...
        endtripbtntext.setTitle("END TRIP".localized, for: UIControlState.normal)
        begintripbtntext.setTitle("BEGIN TRIP".localized, for: UIControlState.normal)
        reachedbtntext.setTitle("Reached".localized, for: UIControlState.normal)
        locatedcancelbtntext.setTitle("CANCEL".localized, for: UIControlState.normal)
        begincancelbtntext.setTitle("CANCEL".localized, for: UIControlState.normal)
        navigatetextlabel.text = "NAVIGATE".localized
       ...
       // GlobalVariables.chatvalue = 0
        
        if (UserDefaults.standard.object(forKey: "accepttrackusername") as? String != nil)
        {
       ...
       // GlobalVariables.rideid = UserDefaults.standard.object(forKey: "acceptdriverid") as! String
        ...
        let query = self.ref.child("Chat").child(GlobalVariables.rideid)
    ...
    @IBAction func callbtn(_ sender: Any) {
        ...
        if let url = URL(string: "telprompt://\(GlobalVariables.trackusermobile)") {
   ...
   @IBAction func edit_drop_location_click(_ sender: Any) {
    ...
    func locationManager(_ manager: CLLocationManager, didUpdateLocations locations: [CLLocation]) {
        if let location = locations.first {
            ...
            GlobalVariables.driverfinishlat = String(location.coordinate.latitude)
            
            GlobalVariables.driverfinishlong = String(location.coordinate.longitude)
    ...
    func reverseGeocodeCoordinate(_ coordinate: CLLocationCoordinate2D) {
        ...
        geocoder.reverseGeocodeCoordinate(coordinate) { response, error in
            if let address = response?.firstResult() {
                ...
                GlobalVariables.driverfinishlat = String(coordinate.latitude)
                
                GlobalVariables.driverfinishlong = String(coordinate.longitude)
   ...
   /* func getDriverLocation(timer : Timer){
    ...
    @IBAction func navigation_btn(_ sender: Any) {
       ...
       // if(UIApplication.shared.canOpenURL(NSURL(string:"https://maps.waze.com")! as URL)){
        ...
        let alert = UIAlertController(title: NSLocalizedString("Selection", comment: ""), message: NSLocalizedString("Select Navigation App", comment: ""), preferredStyle: .actionSheet)
            ...
            let button = UIAlertAction(title: app, style: .default, handler: { (action) in
                ...
                if(app == "Google Maps"){
                    ...
                    if (GlobalVariables.trackridestatus == "3"){
                        ...
                        print("comgooglemaps-x-callback://?saddr=&daddr=\(Float(GlobalVariables.dropLat)!),\(Float(GlobalVariables.dropLong)!)&directionsmode=driving")
                    ...
                    if (GlobalVariables.trackridestatus == "3"){
                        ...
                        let latitude:Double = Double(GlobalVariables.pickupLat)!
                        let longitude:Double = Double(GlobalVariables.pickupLong)!
                        ...
                        let latitude:Double = Double(GlobalVariables.dropLat)!
                        let longitude:Double = Double(GlobalVariables.dropLong)!
                        let urlStr:NSString = NSString(format: "waze://?ll=%f,%f&navigate=yes",latitude, longitude)
                        UIApplication.shared.openURL(NSURL(string: (urlStr as String) as String)! as URL)
                    ...
                    if (GlobalVariables.trackridestatus == "3"){
                        ...
                        UIApplication.shared.openURL(NSURL(string:
                            "http://maps.apple.com/?saddr=&daddr=\(Float(GlobalVariables.pickupLat)!),\(Float(GlobalVariables.pickupLong)!)&directionsmode=driving")! as URL)
                        ...
                        UIApplication.shared.openURL(NSURL(string:
                            "http://maps.apple.com/?saddr=&daddr=\(Float(GlobalVariables.dropLat)!),\(Float(GlobalVariables.dropLong)!)&directionsmode=driving")! as URL)
    ...
    @IBAction func begintrip_btn_click(_ sender: Any) {
        ...
        if (GlobalVariables.dropLat == "0.0" || GlobalVariables.dropLat == ""){
            ...
            let alert = UIAlertController(title: "Before begin trip".localized, message: "Please enter drop location first".localized, preferredStyle: .alert)
        ...
        let refreshAlert = UIAlertController(title: "", message: "Do you want to start ride ? ".localized, preferredStyle: UIAlertControllerStyle.alert)
    ...
    @IBAction func endtrip_btn_click(_ sender: Any) {
        ...
        let refreshAlert = UIAlertController(title: "", message: "Do you want to end ride ? ".localized, preferredStyle: UIAlertControllerStyle.alert)
        ...
        refreshAlert.addAction(UIAlertAction(title: "Yes".localized, style: .default, handler: { (action: UIAlertAction!) in
            ...
            if self.EndLat == ""{
                ...
                if GlobalVariables.driverfinishlat == ""{
                ...
                self.EndLat = GlobalVariables.driverfinishlat
                self.EndLng = GlobalVariables.driverfinishlong
               // self.EndLocation = GlobalVariables.dropLocation
                }
            }
     ...
     func onSuccessState(_ data: AnyObject , resultCode: Int) {
        ...
        if (resultCode == 220){
            ...
            if(self.beginData.result == 419){
              ...
              /* let Message1: NSDictionary = ["message": "0","send_via":"nochat","timestamp": "1291837"]
               self.ref.child("RideTable").child(GlobalVariables.rideid).child("Chat").childByAutoId()*/
        ...
        if resultCode == 143 {
            ...
            if (self.ridedata.result == 1){
                ...
                GlobalVariables.trackusername = (self.ridedata.details?.userName)!
                GlobalVariables.trackusermobile = (self.ridedata.details?.userPhone)!
