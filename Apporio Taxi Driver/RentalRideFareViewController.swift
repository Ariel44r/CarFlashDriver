...
class RentalRideFareViewController: UIViewController,ParsingStates,RatingViewDelegate {
    ...
    @IBOutlet weak var pleaseconfirmrecipttextlabel: UILabel!
    ...
    @IBOutlet weak var totalpayableamountview: UIView!
     ...
     func setupView(){
        pleaseconfirmrecipttextlabel.text = "Please Confirm This Receipt with customer.".localized
        ...
        if (resultCode == 8016){
            ...
            if(rentalridefaredata.status == 1){
               ...
               totalpaymenttextbold.text = GlobalVariables.currencysymbol + " " + (rentalridefaredata.details?.finalBillAmount)!
                ...
                extradistanctraveltext.text = "Extra Distance Travel".localized + "(" + (rentalridefaredata.details?.extraDistanceTravel)! + " )"
               ...
               totalprice.text = GlobalVariables.currencysymbol + " " + (rentalridefaredata.details?.totalamount)!
                ...
                couponappliedtext.text = "Coupon Applied".localized + 
                "( " + (rentalridefaredata.details?.couponcode)! + " )"
                ...
                paymentmodetext.text = "Payment Mode : ".localized + (rentalridefaredata.details?.paymentOptionName)!
