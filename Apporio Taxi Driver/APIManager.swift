...
//     ************************ View Car Models API Parsing *********************************
    ...
    func registerDriver(email: String , phone: String , pass: String , name: String , cartype_id: String ,  carmodelId: String , carnumber: String , cityid: String,DriverCategory: String,DriverBankName: String,DriverAccountNumber: String,DriverAccountName: String, driverimage: UIImage)
    {
        ...
        let dic = ["driver_email":email,
                   ...
                   "driver_account_name":DriverAccountName,
        ...
        
    {
        ...
        let dic = ["driver_email_phone":emailPhone,
        ...
        Alamofire.request(API_URLs.loginMobile, method: .post, parameters: dic)
...
// 4&name=1&email=12&phone=&query=hello
    ...
    func RideLaterAcceptRide(RideId: String,RideMode: String,DriverId: String,DriverToken: String){
        ...
        Alamofire.request(API_URLs.ridelateraccept, method: .post, parameters: dic)
            ...
            .responseJSON { response in
                ...
                case.success( _):
                    ...
                    if let responsedata = response.result.value
                    {
                        ...
                        let dataToParse = JSON(responsedata)
                        print(dataToParse)
                        let  ParsedData = RideLaterAcceptModel(json: dataToParse)
                        self.delegate.onSuccessState(ParsedData , resultCode: 8031)
    ...
    func GetOtpMethod(Phone: String)
    {
        ...
        Alamofire.request(API_URLs.getotpurl, method: .post, parameters: dic)
            ...
            .responseJSON { response in
                ...
                case.success( _):
                    ...
                    if let responsedata = response.result.value
                    {
                        ...
                        self.delegate.onSuccessState(ParsedData , resultCode: 8028)
    ...
    func ForgotGetOtpMethod(Phone: String)
    {
        ...
        Alamofire.request(API_URLs.forgetotpurl, method: .post, parameters: dic)
            ...
            .responseJSON { response in
                ...
                case.success( _):
                    ...
                    if let responsedata = response.result.value
                    {
                        ...
                        self.delegate.onSuccessState(ParsedData , resultCode: 8030)
    ...
    func ChangeUserPassword(Phone: String,Password: String)
    {
        ...
        Alamofire.request(API_URLs.forgotuserpassword, method: .post, parameters: dic)
            ...
            .responseJSON { response in
                ...
                case.success( _):
                    ...
                    if let responsedata = response.result.value
                    {
                        ...
                        self.delegate.onSuccessState(ParsedData , resultCode: 8029)
    ...
    func AppUdateMethod(ApplicationVersion: String)
    {
      ...
      //  self.delegate.onProgressState(0)
        ...
        Alamofire.request(API_URLs.appupdate, method: .post, parameters: dic)
                ...
                case.success( _):
                 ...
                 //   self.delegate.onProgressState(1)
                    ...
                    if let responsedata = response.result.value
                    {
                        ...
                        self.delegate.onSuccessState(ParsedData , resultCode: 8032)
    ...
    func CheckRideTime(Rideid: String,RideMode: String)
        
    {
        
        
        let url = (API_URLs.Checkridetimeurl + "\(Rideid)&ride_mode=\(RideMode)&language_id=\(GlobalVariables.languageid)&language_code=\(GlobalVariables.languagecode)")
            ...
            .responseJSON { response in
                ...
                case.success( _):
                    ...
                    if let responsedata = response.result.value
                    {
                        ...
                        print(responsedata)
                        let dataToParse = JSON(responsedata)
                        let  ParsedData = CheckRideTimeModel(json: dataToParse)
                        self.delegate.onSuccessState(ParsedData , resultCode: 8033)
    ...
    func ScheduleUnacceptedRideMethod(DriverId: String)
        
    {
        
        
        let url = (API_URLs.scheduleunacceptedride + "\(DriverId)&language_id=\(GlobalVariables.languageid)&language_code=\(GlobalVariables.languagecode)")
            ...
            .responseJSON { response in
                ...
                case.success( _):
                    ...
                    if let responsedata = response.result.value
                    {
                        ...
                        print(responsedata)
                        let dataToParse = JSON(responsedata)
                        let  ParsedData = ScheduleRideModel(json: dataToParse)
                        self.delegate.onSuccessState(ParsedData , resultCode: 8034)
        ...
        
    {
        ...
        let url = (API_URLs.reportissueurl + "\(GlobalVariables.languageid)&language_code=\(GlobalVariables.languagecode)")
            ...
            .responseJSON { response in
                ...
                case.success( _):
                    ...
                    if let responsedata = response.result.value
                    {
                        ...
                        self.delegate.onSuccessState(ParsedData , resultCode: 8035)
