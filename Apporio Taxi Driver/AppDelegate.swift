...
class AppDelegate: UIResponder, UIApplicationDelegate, CLLocationManagerDelegate,ParsingStates {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        GMSServices.provideAPIKey("AIzaSyCOg39LntgBTWIC7kak17mZBLx1c6XQGSE")
        ...
        if ((UserDefaults.standard.string(forKey: "PreferredLanguage")) != nil){
            ...
            print (GlobalVariables.languagecode)
            //   Language.language = Language(rawValue: GlobalVariables.languagecode)!
