...
//return JSQMessagesBubbleImageFactory()!.outgoingMessagesBubbleImage(with: UIColor.())
    }()
       ...
       // let defaults = UserDefaults.standard
        ...
        else
        {
         ...
         //   senderId = String(arc4random_uniform(999999))
            ...
            senderId = "Driver"
            senderDisplayName = GlobalVariables.trackusername
        ...
        let query = self.ref1.child("Chat").child(GlobalVariables.rideid)
    ...
    override func collectionView(_ collectionView: JSQMessagesCollectionView!, attributedTextForMessageBubbleTopLabelAt indexPath: IndexPath!) -> NSAttributedString!
    {
        ...
        return messages[indexPath.item].senderId == senderId ? nil : NSAttributedString(string: GlobalVariables.trackusername)
    ...
    override func didPressSend(_ button: UIButton!, withMessageText text: String!, senderId: String!, senderDisplayName: String!, date: Date!)
    {
       ...
       // let ref = ref1.child("RideTable").child(GlobalVariables.rideid).child("Chat").childByAutoId()
        ...
        let ref = self.ref1.child("Chat").child(GlobalVariables.rideid).childByAutoId()
