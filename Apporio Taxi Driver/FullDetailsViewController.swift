...
class FullDetailsViewController: UIViewController,ParsingStates {
   ...
   // var mydatapage: ViewRide!
    ...
    @IBOutlet weak var gotocurrentridebtntextlbl: UIButton!
    
    @IBOutlet weak var topridedetailstextlabel: UILabel!
    
    
    @IBOutlet weak var completetripdetailtextlbl: UILabel!
    
    
    @IBOutlet weak var normalbilldetailstextlbl: UILabel!
    
    @IBOutlet weak var normaltotaldistancetraveltextlbl: UILabel!
    
    
    @IBOutlet weak var normaldistancefaretextlbl: UILabel!
    
    
    @IBOutlet weak var normalridetimechargestextlbl: UILabel!
    
    @IBOutlet weak var normalnighttimechargetextlbl: UILabel!
    
    @IBOutlet weak var normalpeaktimechargetextlbl: UILabel!
    
    @IBOutlet weak var normalwaitingchargetextlbl: UILabel!
    
    
    @IBOutlet weak var normalpaymenttextlbl: UILabel!
    @IBOutlet weak var normaltotalbilltextlbl: UILabel!
    
    
    
    @IBOutlet weak var rentaldistancetraveltextlbl: UILabel!
    
    
    @IBOutlet weak var rentaltotaltimetextlbl: UILabel!
    
    
    @IBOutlet weak var rentaltotalpricetextlbl: UILabel!
    @IBOutlet weak var rentalbilldetailstextlbl: UILabel!
    
    
    @IBOutlet weak var anotherstatustripdetailstextlbl: UILabel!
    
     func setupView(){
        topridedetailstextlabel.text = "Ride Details".localized
        gotocurrentridebtntextlbl.setTitle("GO TO YOUR CURRENT RIDE".localized, for: UIControlState.normal)
        completetripdetailtextlbl.text = "Trip Detail".localized
        normalbilldetailstextlbl.text = "Bill Detail :".localized
        normaltotaldistancetraveltextlbl.text = "Total Distance travel".localized
        normaldistancefaretextlbl.text = "Distance Fare".localized
        normalridetimechargestextlbl.text = "Ride Time Charges :".localized
        normalnighttimechargetextlbl.text = "Night Time Charges :".localized
        normalpeaktimechargetextlbl.text = "Peak Time Charges :".localized
        normalwaitingchargetextlbl.text = "Waiting Charge :".localized
        normalpaymenttextlbl.text = "Payment".localized
        normaltotalbilltextlbl.text = "Total Bill".localized
        rentaldistancetraveltextlbl.text = "Distance Travel :".localized
        rentaltotaltimetextlbl.text = "Total Time :".localized
        rentaltotalpricetextlbl.text = "Total Price :".localized
        rentalbilldetailstextlbl.text = "Bill Details :".localized
        anotherstatustripdetailstextlbl.text = "Trip Detail".localized
        ...
        if (resultCode == 8015){
            ...
            if(rentalridedata.status == 1){
                ...
                if currentstatusvalue == "16"{
                    ...
                    completepickuplocation.text = rentalridedata.details!.endLocation
                    
                    
                    completedroplocation.text  = rentalridedata.details!.pickupLocation
                    ...
                    completedroplocationtimelabel.text = rentalridedata.details?.beginTime
                    completepickuplocationtimelabel.text = rentalridedata.details?.endTime
                    ...
                    rentalpackagetext.text = "Package".localized +  "(" + (rentalridedata.details?.rentalPackageDistance)! + " for " + (rentalridedata.details?.rentalPackageHours)! + " hrs.)"
                    
                    rentalpackageprice.text = GlobalVariables.currencysymbol + " " + (rentalridedata.details?.rentalPackagePrice)!
                    
                    rentalextratimetraveltext.text = "Extra Distance Travel".localized + "(" + (rentalridedata.details?.extraDistanceTravel)! + " )"
                    
                    rentalextratimetravelprice.text = GlobalVariables.currencysymbol + " " + (rentalridedata.details?.extraDistanceTravelCharge)!
                    
                    rentalextraestimatetimetext.text = "Extra Estimated time".localized +  "(" + (rentalridedata.details?.extraHoursTravel)! + "hrs.)"
                    ...
                    rentalcouponcodetext.text = "Coupon Applied".localized + " ( " + (rentalridedata.details?.couponcode)! + " )"
                    ...
                    rentaltotalpayableamounttext.text = "Total Payable Amount".localized + "( " + (rentalridedata.details?.paymentname)! + " )"
                    ...
                    anotherpickuplocation.text = rentalridedata.details?.endLocation
                    anotheruserphone.text = rentalridedata.details?.userPhone
                    anotherdroplocation.text = rentalridedata.details?.pickupLocation
                    
                    anotherdroplocationtimelabel.text = rentalridedata.details?.beginTime
                    anotherpickuplocationtimelabel.text = rentalridedata.details?.endTime
        ...
        if (resultCode == 8014){
            ...
            if(normalridedata.status == 1){
                ...
                if currentstatusvalue == "7"{
                    ...
                    completepickuplocation.text = normalridedata.details!.dropLocation
                    
                    
                    
                    completedroplocation.text  = normalridedata.details!.pickupLocation
                    ...
                    completedroplocationtimelabel.text = normalridedata.details?.beginTime
                    completepickuplocationtimelabel.text = normalridedata.details?.endTime
                    
                    completecoupontext.text = "Coupon Applied".localized +  "( " + (normalridedata.details?.couponCode)! + " )"
                    ...
                    anotherpickuplocation.text = normalridedata.details?.dropLocation
                    anotheruserphone.text = normalridedata.details?.userPhone
                    anotherdroplocation.text = normalridedata.details?.pickupLocation
                    
                    anotherdroplocationtimelabel.text = normalridedata.details?.beginTime
                    anotherpickuplocationtimelabel.text = normalridedata.details?.endTime
