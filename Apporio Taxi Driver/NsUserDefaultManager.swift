...
public class NsUserDefaultManager {
    ...
    internal static let keydriverbankname = "driver_bank_name"
    internal static let keydriversaccountname = "driver_account_name"
    internal static let keydriveraccountnumber = "driver_account_number"
   ...
   // internal static let keyonlineofflinestatus = "onofflinestatus"
    ...
    func registerDriver(insurance : String  , rc : String  ,  licence : String , did : String , carModelId : String , otherDoc : String , driverId : String , driverImg : String , driverEmail : String  , driverName: String ,  flag : String  ,  long : String , cityid : String , carNo : String , password : String , lat : String , phoneNo : String , carType : String , onOff : String , status : String , loginLogout : String,driverToken : String,detailStatus : String,carmodelname : String , cartypename : String ,cityname : String, Driverstatusimage: String,Driverstatusmessage: String,DriverBankName: String,DriverAccountName: String,DriverAccountNumber: String){
        ...
        UserDefaults.standard.setValue(DriverBankName, forKey: "driver_bank_name")
        UserDefaults.standard.setValue(DriverAccountName, forKey: "driver_account_name")
        UserDefaults.standard.setValue(DriverAccountNumber, forKey: "driver_account_number")
    ...
    func logOut(){
        ...
        defaults.removeObject(forKey: "driver_bank_name")
        defaults.removeObject(forKey: "driver_account_name")
        defaults.removeObject(forKey: "driver_account_number")
