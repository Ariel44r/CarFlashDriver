...
class DocumentStatusViewController: UIViewController,ParsingStates,UITableViewDelegate,UITableViewDataSource {
    ...
    @IBOutlet weak var documentstatustextlabel: UILabel!
    
    
    @IBOutlet weak var pleaseuploadrequiredtextlabel: UILabel!
    ...
    override func viewDidLoad() {
        ...
        pleaseuploadrequiredtextlabel.text = "Please Upload Required Document in order To complete the Process. You will be able to use our service only when admin will verify the documents.".localized
        documentstatustextlabel.text = "Document Status".localized
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if documentverificationid == "0"{
            ...
            uploadstatus.text = "Upload".localized
            
        }
         if documentverificationid == "1"{
            
            uploadstatus.text = "Not yet Verified".localized
        }
        if documentverificationid == "2"{
         ...
         if documentverificationid == "3"{
            ...
            uploadstatus.text = "Please upload Again".localized
        }
    ...
    func onSuccessState(_ data: AnyObject , resultCode: Int) {
        ...
        if resultCode == 8026{
            ...
            if documentlistdata.result == 1 {
                ...
                let alert = UIAlertController(title: "", message: "No document in your city".localized, preferredStyle: .alert)
