...
class RentalTrackRideViewController: UIViewController,CLLocationManagerDelegate , ParsingStates ,GMSMapViewDelegate {
 ...
 //   var data: Arrived!
  //  var updateData: UpdateDriverLocation!
    ...
    @IBOutlet weak var locatedbtntext: UIButton!
    ...
    override func viewDidLoad() {
        ...
        locatedbtntext.setTitle("Reached".localized, for: UIControlState.normal)
        ...
        if (UserDefaults.standard.object(forKey: "rentaltrackusername") as? String != nil)
        {
