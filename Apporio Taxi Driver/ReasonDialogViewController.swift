...
class ReasonDialogViewController: UIViewController,UITableViewDataSource,UITableViewDelegate,ParsingStates {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
       ...
       // GlobalVariables.cancelId = self.reasonData.msg![row].reasonId!
        ...
        cancel_btn.layer.backgroundColor = ReasonDialogViewController.getColorFromHex("#000000").cgColor
    ...
    func onSuccessState(_ data: AnyObject , resultCode: Int) {
        ...
        if resultCode == 1006{
            ...
            if self.cancelData.result == 1{
                ...
                let alert = UIAlertController(title: "", message: "Booking Cancelled !".localized, preferredStyle: .alert)
                let action = UIAlertAction(title: NSLocalizedString("OK", comment: ""), style: .default) { _ in
