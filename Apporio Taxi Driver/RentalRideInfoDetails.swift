...
public class RentalRideInfoDetails: NSObject {
    ...
    internal let kDetailsPackagePriceKey: String = "package_price"
    internal let kDetailsPackageNameKey: String = "package_name"
    internal let kDetailsPaymentOptionNameKey: String = "payment_option_name"
    internal let kDetailsDriverrequesttimeKey: String = "driver_request_time"
    internal let kDetailsdifferenceInSecondsKey: String = "differenceInSeconds"
    ...
    public var driverrequesttime: String?
    public var differenceInSeconds: String?
    ...
    */
    public init(json: JSON) {
        ...
        packageprice = json[kDetailsPackagePriceKey].string
        packagename = json[kDetailsPackageNameKey].string
        paymentOptionName = json[kDetailsPaymentOptionNameKey].string
        driverrequesttime = json[kDetailsDriverrequesttimeKey].string
        differenceInSeconds = json[kDetailsdifferenceInSecondsKey].string
    ...
    */
    public func dictionaryRepresentation() -> [String : AnyObject ] {
        ...
        if packageprice != nil {
            dictionary.updateValue(packageprice! as AnyObject, forKey: kDetailsPackagePriceKey)
        }
        if packagename != nil {
           dictionary.updateValue(packagename! as AnyObject, forKey: kDetailsPackageNameKey)
        }
        if paymentOptionName != nil {
            dictionary.updateValue(paymentOptionName! as AnyObject, forKey: kDetailsPaymentOptionNameKey)
        }
        if driverrequesttime != nil {
            dictionary.updateValue(driverrequesttime! as AnyObject, forKey: kDetailsDriverrequesttimeKey)
        }
        if differenceInSeconds != nil {
            dictionary.updateValue(differenceInSeconds! as AnyObject, forKey: kDetailsdifferenceInSecondsKey)
        }
