...
class CameraViewController: UIViewController,UIImagePickerControllerDelegate, UINavigationControllerDelegate {
    ...
    @IBOutlet weak var pleaseuploadaphototextlabel: UILabel!

    @IBOutlet weak var okbtntext: UIButton!
    override func viewDidLoad() {
        super.viewDidLoad()
        
        pleaseuploadaphototextlabel.text = "Please Upload a photo of your meter of your car or motorcycle"
        okbtntext.setTitle("Ok".localized, for: UIControlState.normal)
        entermetervalue.placeholder = "Enter meter value".localized
    ...
    @IBAction func okbtnclick(_ sender: Any) {
        ...
        if GlobalVariables.meterimage.isEqual("") {
            let alert = UIAlertController(title: "Add Details".localized, message: "Please first add Meter Reading Image ".localized, preferredStyle: .alert)
