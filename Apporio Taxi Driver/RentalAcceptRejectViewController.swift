...
class RentalAcceptRejectViewController: UIViewController,ParsingStates {
   ...
   // @IBOutlet weak var scrollview: UIScrollView!
    ...
    @IBOutlet weak var packagetextlabel: UILabel!
    
    @IBOutlet weak var timetextlabel: UILabel!
    
    @IBOutlet weak var packagepricetextlabel: UILabel!
    
    @IBOutlet weak var pickuppointtextlabel: UILabel!
    
    @IBOutlet weak var acceptbtntext: UIButton!
    
    @IBOutlet weak var passbtntext: UIButton!
    ...
    override func viewDidLoad() {
        ...
        packagetextlabel.text = "Package".localized
        timetextlabel.text = "Time".localized
        packagepricetextlabel.text = "Package Price".localized
        pickuppointtextlabel.text = "Pick up Point".localized
        
        acceptbtntext.setTitle("Accept".localized, for: UIControlState.normal)
        passbtntext.setTitle("Pass".localized, for: UIControlState.normal)
    ...
    func onSuccessState(_ data: AnyObject , resultCode: Int) {
        ...
        if (resultCode == 8007){
            ...
            if(self.rentalrideinfodata.status == 1){
               ...
               let timerrequest = (self.rentalrideinfodata.details?.driverrequesttime)!
              let differencetime = (self.rentalrideinfodata.details?.differenceInSeconds)!
              ...
              //  let finaltime = 40.0
                ...
                helloWorldTimer = Timer.scheduledTimer(timeInterval: TimeInterval(finaltime), target: self, selector: #selector(RentalAcceptRejectViewController.sayHello), userInfo: nil, repeats: false)
                
                 self.helloWorldTimer1 = Timer.scheduledTimer(timeInterval: 17.0, target: self, selector: #selector(RentalAcceptRejectViewController.sayHello1), userInfo: nil, repeats: true)
                ...
                self.toppackageselecttext.text = self.rentalrideinfodata.details?.packagename
                 ...
                 self.paymentmodetext.text = "Payment Mode : ".localized + (self.rentalrideinfodata.details?.paymentOptionName)!
