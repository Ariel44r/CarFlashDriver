...
class NewEarningController: UIViewController,ParsingStates  {
    ...
    override func viewDidLoad() {
        ...
        viewoldsummerytextlabel.text = "VIEW OLD SUMMARY".localized
        viewfullsummerytextlabel.text = "VIEW FULL SUMMARY".localized
        yourearningtextlabel.text = "Your Earning".localized
        totaloutstandingtextlabel.text = "Total OutStanding".localized
        totalpaypotlabeltext.text = "Total Payout".localized
